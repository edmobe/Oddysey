...
public class BTree<Key extends Comparable<Key>, Value>  {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        st.put("macarena", "datos macarenos");
        st.put("abrazame", "datos abrazables");
        st.put("macarena", "otros datos macarenos");
        st.put("take on me", "datos de take on me");
        st.put("hola", "datos saludables");
